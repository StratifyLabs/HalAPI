...
printer::Printer &printer::operator<<(printer::Printer &printer,
  ...
  return printer.key("flags", var::NumberString(a.o_flags()))
      ...
      .key("channel0",
           var::NumberString().format("%d.%d", a.pin_assignment_channel0().port,
                                      a.pin_assignment_channel0().pin))
      .key("channel1",
           var::NumberString().format("%d.%d", a.pin_assignment_channel1().port,
                                      a.pin_assignment_channel1().pin))
      .key("channel2",
           var::NumberString().format("%d.%d", a.pin_assignment_channel2().port,
                                      a.pin_assignment_channel2().pin))
      .key("channel3",
           var::NumberString().format("%d.%d", a.pin_assignment_channel3().port,
                                      a.pin_assignment_channel3().pin));
}

printer::Printer &printer::operator<<(printer::Printer &printer,
                                      const hal::Pwm::Info &a) {
